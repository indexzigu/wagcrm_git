...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[180px] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-3 py-2 text-xs shadow-overlay",
        className,
      )}
    >
              ...
              >
                {formatter && item.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        "flex flex-1 justify-between items-center leading-none gap-4",
                      )}
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
