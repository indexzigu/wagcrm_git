 ...
 *
 * 색은 승인 팔레트에서 전달. 기본값 골드는 **장식 액센트**일 뿐이다 — 이익률처럼 판정이
 * 걸린 값은 호출부가 `PROFIT_TONE_FILL`(profit-tone.ts)을 넘긴다(손익 리포트 선례). 골드는
 * 가드레일 3 의 예외 2건(배송완료 · 목표 달성 밴드) 밖으로 의미를 싣지 않는다.
 */
