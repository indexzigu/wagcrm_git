 ...
 *
 * - 웹 어시스턴트가 하던 「READ 자동 기록」(`/api/assistant/route.ts`)과 같은 모양이라
 *   결재함 카드·표 렌더가 그대로 재사용된다(설계 정본: docs/private/specs/2026-09-22-assistant-renewal-approval-hub-design.md §3-A).
...
/** structuredResult 직렬화 상한 — 어시스턴트 채팅의 toolCalls 저장 계약(64KB)과 같은 값. */
